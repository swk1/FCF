...
from codes.utils.OtherUtils import get_dataset_dict, CodeChangeArguments, add_special_tokens_to_tokenizer
...
def run_MLM():
    ...
    if len(sys.argv) == 2 and sys.argv[1].endswith(".json"):
        ...
        model_args, data_args, training_args, code_change_args = \
    ...
    # Get the dataset
    raw_datasets = get_dataset_dict(code_change_args, tokenizer, MLMDataset)
    ...
    if training_args.do_train:
        ...
        with open(os.path.join(training_args.output_dir, "saved_model.pkl"), "wb") as dump_file:
