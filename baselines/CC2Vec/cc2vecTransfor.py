import argparse
import pickle
from baselines.CC2Vec.jit_padding import padding_message, clean_and_reformat_code, padding_commit_code, \
    mapping_dict_msg, mapping_dict_code, convert_msg_to_label
...
def cc2ftr_train(params,train_data,dictionary_data,save_dir,visible_device):
    params.train_data = train_data
    params.dictionary_data = dictionary_data
    params.save_dir = save_dir
    params.visible_device = visible_device
    ...
    pad_added_code = padding_commit_code(data=added_code, max_file=params.code_file, max_line=params.code_line,
                                         max_length=params.code_length)
    pad_removed_code = padding_commit_code(data=removed_code, max_file=params.code_file, max_line=params.code_line,
                                           max_length=params.code_length)
...
def cc2ftr_predict(params,batch_size,predict_data,dictionary_data,load_model,name):
    params.predict_data = predict_data
