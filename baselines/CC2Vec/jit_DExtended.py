...
def Dextended_train(params,train_data,train_data_cc2ftr,dictionary_data,save_dir):
    params.train_data = train_data
    params.train_data_cc2ftr = train_data_cc2ftr
    params.dictionary_data = dictionary_data
    params.save_dir = save_dir
    Dextended_set_seed(seed=42)
...
def Dextended_predict(params, pred_data, pred_data_cc2ftr, load_model):
    params.pred_data = pred_data
    params.pred_data_cc2ftr = pred_data_cc2ftr
