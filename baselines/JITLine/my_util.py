...
def load_data(proj, mode='train', use_text=True, remove_python_common_tokens=False, data_dir='./data/'):
    data_dir = 'C:/Users/Administrator/Desktop/毕业论文/论文代码/JIT-BiCC-main/JIT-BiCC-main/data/jitline/'
    if mode == 'train':
...
# 修改了数据的读取路径
def prepare_data(cur_proj, mode='train', use_text=True, remove_python_common_tokens=False, data_dir='C:/Users/Administrator/Desktop/毕业论文/论文代码/JIT-BiCC-main/JIT-BiCC-main/data/jitline/data/'):
    if use_text:
