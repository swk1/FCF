...
from JITFine.my_util import TextDataset, eval_result, create_path_if_not_exist

logger = logging.getLogger(__name__)

from huggingface_hub import snapshot_download
snapshot_download(
    repo_id="microsoft/codebert-base",  # 指定要下载的模型仓库
    cache_dir="./models",
